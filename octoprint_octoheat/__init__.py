...
class OctoHeatPlugin(
    ...
    def get_settings_defaults(self):
        return {
            ...
            const.SETTING_TARGET_TEMP: 30,
            const.SETTING_OFFSET_VALUE: -10,
            const.SETTING_OFFSET_PERCENT: -5,
            const.SETTING_OFFSET_TYPE: "raw",
            const.SETTING_HYSTERESIS: 3,
            const.SETTING_UPDATE_INTERVAL: 60,
            const.SETTING_TEMP_TIMEOUT: 120,
            const.SETTING_HEATER_MODE: const.HEATER_MODE_AUTO,
            const.SETTING_THERMAL_RUNAWAY_TEMP: 60,
